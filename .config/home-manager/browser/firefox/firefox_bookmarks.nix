    ...
    bookmarks = [
      {
        ...
        bookmarks = [
          ...
          {
            name = "Mega";
            url = "https://mega.nz/folder/0Sg0iD4B#0OPF1JJgFjtYoJuStlsCtA/folder/EbpFDBAa";
          }
          {
            name = "Computer Science Open-University first degree";
