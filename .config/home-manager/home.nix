...
{
  imports = [ ./browser ./terminal ./software-development ./basic ./wm ./social ./windows ./utils ];

  options = {
    settings.gui.enable = lib.mkOption { type = lib.types.bool; };
    settings.development.enable = lib.mkOption { type = lib.types.bool; };
  };
